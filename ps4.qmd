...
# Load the dataset
path_2016 = 'C:/Users/raiha/Documents/GitHub/problem-set-4-astari-and-surya/pos2016.csv'
data_2016 = pd.read_csv(path_2016, encoding='ISO-8859-1')
```

```{python}
# Filter the dataset
filtered_2016 = data_2016[
...
path_2018 = 'C:/Users/raiha/Documents/GitHub/problem-set-4-astari-and-surya/pos2018.csv'
data_2018 = pd.read_csv(path_2018, encoding='ISO-8859-1')

# Filter the dataset
filtered_2018 = data_2018[
    (data_2018['PRVDR_CTGRY_SBTYP_CD'] == 1) & 
    (data_2018['PRVDR_CTGRY_CD'] == 1)
]
...
```{python}
# Load the 2019 data
path_2019 = 'C:/Users/raiha/Documents/GitHub/problem-set-4-astari-and-surya/pos2019.csv'
data_2019 = pd.read_csv(path_2019, encoding='ISO-8859-1')

# Filter the dataset
filtered_2019 = data_2019[
    (data_2019['PRVDR_CTGRY_SBTYP_CD'] == 1) & 
    (data_2019['PRVDR_CTGRY_CD'] == 1)
]
