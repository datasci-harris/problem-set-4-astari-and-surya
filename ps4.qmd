...
pos2016 = pd.read_csv(path_2016, encoding='ISO-8859-1')
```
...
pos2017 = pd.read_csv(path_2017, encoding='ISO-8859-1')
...
pos2018 = pd.read_csv(path_2018, encoding='ISO-8859-1')
...
pos2019 = pd.read_csv(path_2019, encoding='ISO-8859-1')
...
# Inner merge
zips_withhospital_centroids = zips_withhospital_centroids.merge(
    act_hos_2016["ZIP_CD"],
    left_on = "ZCTA5",
    right_on = "ZIP_CD",
